...
class ManagerController extends Controller
{
     ...
     * 初始化仓库
     */
    public function __construct(ManagerRepository $manager,RoleRepository $role,PlatformRepository $platform)
    {
        $this->role = $role;
    ...
    public function create()
    {
        ...
        //dump($GetPfNameId);
        return view('admin.manager.create',compact('roleNameIdStatus','GetPfNameId'));
    }
    ...
    public function edit($id)
    {
        ...
        $roleNameIdStatus = $this->role->GetRoleNameIdStatus();
        $GetPfNameId = $this->platform->GetPfNameId();
        $manager->mg_id === 1?$manager->root = true:$manager->root = false;
        //dump($manager);
        return view('admin.manager.edit',compact('manager','roleNameIdStatus','GetPfNameId'));
    }
