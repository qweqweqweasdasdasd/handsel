...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
           ...
           <!--  <li>
                <a href="javascript:;">
                    <i class="layui-icon" lay-tips="订单审核">&#xe6b2;</i>
                    <cite>订单审核</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('审核','/admin/recheck')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>审核列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="layui-icon" lay-tips="下发管理">&#xe65e;</i>
                    <cite>下发管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('订单列表','/admin/order')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>订单列表</cite></a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('银行列表','/admin/bank')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>银行列表</cite></a>
                    </li>
                </ul>
           ...
           <li>
                ...
                <ul class="sub-menu">
                   ...
                   <!--  <li>
                        <a onclick="xadmin.add_tab('申请列表','/admin/')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>申请列表</cite></a>
                    </li> -->
                    <!-- <li>
            ...
            <li>
                <a href="javascript:;">
                    <i class="layui-icon" lay-tips="申请彩金">&#xe6b2;</i>
                    <cite>申请彩金</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('彩金列表','/admin/handsel')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>彩金列表</cite></a>
                    </li>
                </ul>
             ...
             <!-- <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="令牌管理">&#xe723;</i>
                    <cite>令牌管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('令牌列表','/admin/token')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>令牌列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="商户管理">&#xe723;</i>
                    <cite>平台管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('平台列表','/admin/platform')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>平台列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <!-- <li>
                        <a onclick="xadmin.add_tab('权限分类','/admin/cate')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限分类</cite></a>
                    </li> -->
                    <li>
