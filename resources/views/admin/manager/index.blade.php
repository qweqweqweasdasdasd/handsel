                ...
                <div class="layui-card">
                    <div class="layui-card-body ">
                        <form class="layui-form layui-col-space5">
                            ...
                            <div class="layui-inline layui-show-xs-block">
                                <input type="text" name="mg_name" value="{{$whereData['mg_name']}}" placeholder="请输入管理员名" autocomplete="off" class="layui-input" style="width:250px;">
                            </div>
                            <div class="layui-inline layui-show-xs-block">
                        ...
                        <table class="layui-table layui-form">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="layui-badge @if($manager->platform->platform_status == 1) layui-bg-blue @else layui-bg-gray @endif" >{{$manager->platform->pf_name}}</span>
